...
const DEFAULTS = {
  ...
  paddleExtraParams: '{"det_db_thresh":0.3,"det_db_box_thresh":0.6,"detMean":[0.5, 0.5, 0.5],"detStd":[0.5, 0.5, 0.5],"det_db_unclip_ratio":1.5,"erode_size":1}',
  xSpacing: 15,
  ySpacing: 15,
...
const I18N = {
  en: {
    ...
    settings_ocr_backend_force_webgpu: 'Force WebGPU (try on any browser)',
    settings_ocr_backend_wasm: 'WebAssembly',
    ...
    settings_paddle_det_model: 'PaddleOCR Detection Model',
    settings_paddle_det_tiny: 'Tiny (faster)',
    settings_paddle_det_small: 'Small (more accurate)',
    settings_paddle_extra_params: 'PaddleOCR Extra Params (JSON)',
  ...
  zh: {
    ...
    settings_ocr_backend_force_webgpu: '强制WebGPU（任何浏览器都尝试）',
    settings_ocr_backend_wasm: 'WebAssembly',
    settings_x_spacing: 'X间距（px）',
    settings_y_spacing: 'Y间距（px）',
    settings_use_yolo: '使用YOLO检测文字',
    settings_use_yolo_jp: '日语使用YOLO检测',
    settings_paddle_det_model: 'PaddleOCR检测模型',
    settings_paddle_det_tiny: 'Tiny（更快）',
    settings_paddle_det_small: 'Small（更准确）',
    settings_paddle_extra_params: 'PaddleOCR额外参数（JSON）',
...
// `zh` holds the Chinese name shown on the Chinese pages; on other pages the
// English `name` is used.
const LANGUAGE_CODES = [
  {name: 'Arabic', zh: '阿拉伯语', code: 'ar'},
  {name: 'English', zh: '英语', code: 'en'},
  {name: 'Chinese', zh: '中文', code: 'zh'},
  {name: 'Japanese', zh: '日语', code: 'ja'},
  {name: 'Korean', zh: '韩语', code: 'ko'},
  {name: 'French', zh: '法语', code: 'fr'},
  {name: 'Italian', zh: '意大利语', code: 'it'},
  {name: 'Spanish', zh: '西班牙语', code: 'es'},
  {name: 'Russian', zh: '俄语', code: 'ru'},
  {name: 'Portuguese', zh: '葡萄牙语', code: 'pt'},
  {name: 'Indonesian', zh: '印度尼西亚语', code: 'id'},
  {name: 'Vietnamese', zh: '越南语', code: 'vi'},
  {name: 'Thai', zh: '泰语', code: 'th'},
  {name: 'Malay', zh: '马来语', code: 'ms'},
  {name: 'Hindi', zh: '印地语', code: 'hi'},
  {name: 'Bengali', zh: '孟加拉语', code: 'bn'},
  {name: 'Urdu', zh: '乌尔都语', code: 'ur'},
  {name: 'Persian', zh: '波斯语', code: 'fa'},
  {name: 'Turkish', zh: '土耳其语', code: 'tr'},
  {name: 'German', zh: '德语', code: 'de'},
  {name: 'Tamil', zh: '泰米尔语', code: 'ta'},
  {name: 'Telugu', zh: '泰卢固语', code: 'te'},
  {name: 'Marathi', zh: '马拉地语', code: 'mr'},
  {name: 'Gujarati', zh: '古吉拉特语', code: 'gu'},
  {name: 'Kannada', zh: '卡纳达语', code: 'kn'},
  {name: 'Malayalam', zh: '马拉雅拉姆语', code: 'ml'},
  {name: 'Punjabi', zh: '旁遮普语', code: 'pa'},
  {name: 'Nepali', zh: '尼泊尔语', code: 'ne'},
  {name: 'Sinhala', zh: '僧伽罗语', code: 'si'},
  {name: 'Hebrew', zh: '希伯来语', code: 'he'},
  {name: 'Swahili', zh: '斯瓦希里语', code: 'sw'},
  {name: 'Amharic', zh: '阿姆哈拉语', code: 'am'},
  {name: 'Hausa', zh: '豪萨语', code: 'ha'},
  {name: 'Yoruba', zh: '约鲁巴语', code: 'yo'},
  {name: 'Zulu', zh: '祖鲁语', code: 'zu'},
  {name: 'Afrikaans', zh: '南非荷兰语', code: 'af'},
  {name: 'Dutch', zh: '荷兰语', code: 'nl'},
  {name: 'Polish', zh: '波兰语', code: 'pl'},
  {name: 'Ukrainian', zh: '乌克兰语', code: 'uk'},
  {name: 'Romanian', zh: '罗马尼亚语', code: 'ro'},
  {name: 'Greek', zh: '希腊语', code: 'el'},
  {name: 'Czech', zh: '捷克语', code: 'cs'},
  {name: 'Swedish', zh: '瑞典语', code: 'sv'},
  {name: 'Danish', zh: '丹麦语', code: 'da'},
  {name: 'Norwegian', zh: '挪威语', code: 'no'},
  {name: 'Finnish', zh: '芬兰语', code: 'fi'},
  {name: 'Hungarian', zh: '匈牙利语', code: 'hu'},
  {name: 'Serbian', zh: '塞尔维亚语', code: 'sr'},
  {name: 'Croatian', zh: '克罗地亚语', code: 'hr'},
  {name: 'Slovak', zh: '斯洛伐克语', code: 'sk'},
  {name: 'Slovenian', zh: '斯洛文尼亚语', code: 'sl'},
  {name: 'Bulgarian', zh: '保加利亚语', code: 'bg'},
  {name: 'Macedonian', zh: '马其顿语', code: 'mk'},
  {name: 'Albanian', zh: '阿尔巴尼亚语', code: 'sq'},
  {name: 'Bosnian', zh: '波斯尼亚语', code: 'bs'},
  {name: 'Lithuanian', zh: '立陶宛语', code: 'lt'},
  {name: 'Latvian', zh: '拉脱维亚语', code: 'lv'},
  {name: 'Estonian', zh: '爱沙尼亚语', code: 'et'},
  {name: 'Icelandic', zh: '冰岛语', code: 'is'},
  {name: 'Irish', zh: '爱尔兰语', code: 'ga'},
  {name: 'Welsh', zh: '威尔士语', code: 'cy'},
  {name: 'Catalan', zh: '加泰罗尼亚语', code: 'ca'},
  {name: 'Galician', zh: '加利西亚语', code: 'gl'},
  {name: 'Basque', zh: '巴斯克语', code: 'eu'},
  {name: 'Maltese', zh: '马耳他语', code: 'mt'},
  {name: 'Azerbaijani', zh: '阿塞拜疆语', code: 'az'},
  {name: 'Kazakh', zh: '哈萨克语', code: 'kk'},
  {name: 'Uzbek', zh: '乌兹别克语', code: 'uz'},
  {name: 'Kyrgyz', zh: '吉尔吉斯语', code: 'ky'},
  {name: 'Tajik', zh: '塔吉克语', code: 'tg'},
  {name: 'Mongolian', zh: '蒙古语', code: 'mn'},
  {name: 'Armenian', zh: '亚美尼亚语', code: 'hy'},
  {name: 'Georgian', zh: '格鲁吉亚语', code: 'ka'},
  {name: 'Khmer', zh: '高棉语', code: 'km'},
  {name: 'Lao', zh: '老挝语', code: 'lo'},
  {name: 'Burmese', zh: '缅甸语', code: 'my'},
  {name: 'Filipino', zh: '菲律宾语', code: 'tl'},
  {name: 'Javanese', zh: '爪哇语', code: 'jv'},
  {name: 'Sundanese', zh: '巽他语', code: 'su'},
  {name: 'Yiddish', zh: '意第绪语', code: 'yi'},
  {name: 'Pashto', zh: '普什图语', code: 'ps'},
  {name: 'Kurdish', zh: '库尔德语', code: 'ku'},
  {name: 'Sindhi', zh: '信德语', code: 'sd'},
  {name: 'Uyghur', zh: '维吾尔语', code: 'ug'},
  {name: 'Auto', zh: '自动', code: 'auto'}
];

// Display name for a language option, localized to the current UI language.
function langName(lang) {
  if (Settings.get('uiLanguage') === 'zh_CN' && lang.zh) return lang.zh;
  return lang.name;
}
