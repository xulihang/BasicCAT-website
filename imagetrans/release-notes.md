...
* New OCR plugin£ºmacOS's built-in OCR [#issue341](https://github.com/xulihang/ImageTrans-docs/issues/341)
...
* New image inpainting plugin£ºLama Inpainting [#issue216](https://github.com/xulihang/ImageTrans-docs/issues/216)
...
* Add a new Japanese OCR plugin£º[ÕiÈ¡¸ïÃü(Yomikaku)](https://github.com/xulihang/ImageTrans-docs/issues/83).
* Other bug fixes
...
* Better conversion of vertically displayed Japanese textareas to horizontally displayed ones (rotation and center placement of characters like ¡ª)
