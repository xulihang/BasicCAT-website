...
* Add support for storing extra params for the "Append OCR result to existing areas" workflow item
...
* Fix a bug for pretranslation skipping images with no text to translate
