...
### BasicCAT v1.9.5_beta

* Windows: [32bit](https://github.com/xulihang/BasicCAT/releases/download/v1.9.5_beta/BasicCAT-windows-x86.exe) /  [64bit](https://github.com/xulihang/BasicCAT/releases/download/v1.9.5_beta/BasicCAT-windows-x64.exe)
* macOS:  [DMG](https://github.com/xulihang/BasicCAT/releases/download/v1.9.5_beta/BasicCAT_mac.dmg)
* Linux and the other:  [CrossPlatfroms.zip](https://github.com/xulihang/BasicCAT/releases/download/v1.9.5_beta/BasicCAT-crossplatforms.zip)
