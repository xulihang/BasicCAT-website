...
1. AI驱动的语音识别和语音活动检测功能。使用了OpenAI Whisper、Qwen3-ASR等人工智能模型。支持英语、汉语、日语、粤语等各种语言。支持上海话、闽南语等各种汉语方言。
...
* [Windows (x86_64)](https://github.com/xulihang/Silhouette/releases/download/v1.6.1/Silhouette-windows-x64.zip)
* [macOS (Apple CPU)](https://github.com/xulihang/Silhouette/releases/download/v1.6.1/Silhouette-mac-arm.dmg)
* [macOS (Intel CPU)](https://github.com/xulihang/Silhouette/releases/download/v1.6.1/Silhouette-mac-x64.dmg)
