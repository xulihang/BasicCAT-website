...
![不清晰电子墨水屏](/album/clean-scanned-document/uncleaned-on-eink-tablet.jpg){: width="1734" height="1734"}


最后我经过一番处理，得到了一个清晰版的PDF，总算在电子墨水设备上能看了。

![清晰电子墨水屏](/album/clean-scanned-document/cleaned-on-eink-tablet.jpg){: width="1734" height="1734"}

下面是经过的处理步骤。

原图：

![原图](/album/clean-scanned-document/original.jpg){: width="1566" height="2334"}
...
![矫正版](/album/clean-scanned-document/deskewed.jpg){: width="1582" height="2345"}

识别图片中的文字，以文字区域为单位进行二值化，得到只有黑白两种颜色的版本：

![黑白版](/album/clean-scanned-document/black-white.png){: width="1582" height="2345"}
