...
[文件链接](/album/vertical-text-PDF/reconstructed-pdf.pdf)


## 操作方法

需要用到[ImageTrans](/zh/imagetrans/)这款OCR软件。

1. 使用自带的气泡检测功能，检测竖排文字行。
2. 使用大语言模型进行OCR。因为这里文字比较模糊，只有大语言模型才有比较好的效果，我这里选用了`qwen3-vl-235b-a22b-instruct`这个模型。
