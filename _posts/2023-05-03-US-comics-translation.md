...
5. Manually translate each area. We can compare the results of multiple machine translation engines, or use the machine translation result directly.
   ...
   We will encounter a lot of names in American comic translation, such as Janet, whose machine translation in Chinese is ¡°ÕäÄÝÌØ¡±. If we want to translate to ¡°Õ²ÄáÌØ¡±, we can add an auto-correct rule that replaces ¡°ÕäÄÝ¡± with ¡°Õ²Äá¡±.
